...
using Ocean.VistaBridgeLibrary.Properties;
    ...
    public abstract class VistaFileDialog : CommonDialog
    {
                    ...
                    if( value != _filter )
                    {
                        if( !string.IsNullOrEmpty(value) )
                        {
                            ...
                            if( filterElements == null || filterElements.Length % 2 != 0 )
                                throw new ArgumentException(Resources.VistaFileDialog_Filter_Invalid_filter_string);
        ...
        internal virtual void SetDialogProperties(IFileDialog dialog)
        {
            ...
            if( _showHelp )
            {
                ...
                customize.AddPushButton(HelpButtonId, Resources.VistaFileDialog_SetDialogProperties_Help);
            }
