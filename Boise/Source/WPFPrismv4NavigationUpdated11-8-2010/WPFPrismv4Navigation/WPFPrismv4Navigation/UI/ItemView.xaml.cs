...
namespace WPFPrismv4Navigation.UI {
    ...
    /// 
    /// Notice that this View has a CreationPolicy of NonShared.  This instructs MEF to provide
    /// a new instance from the container as opposed to returning the same instance.
    /// </summary>
    [Export(ViewNames.ItemView)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class ItemView : UserControl, IPartImportsSatisfiedNotification, IConfirmNavigationRequest {
        ...
        /// <summary>
        /// Gets or sets the <see cref="ItemViewModel"/>.
