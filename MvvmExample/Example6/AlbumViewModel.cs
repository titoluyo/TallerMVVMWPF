...
namespace Example6
{
    class AlbumViewModel
    {
        ...
        void DetalleExecute()
        {
            ...
            songView.DataContext = _songs[0];
            songView.Top = 100;
            songView.Left = 400;
            songView.Show();
        }

        bool CanDetalleExecute() { return true; }

        public ICommand DetalleCommand{get{return new RelayCommand(DetalleExecute, CanDetalleExecute);}}
