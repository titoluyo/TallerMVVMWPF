...
{
    /// <summary>
    /// Provides an interface replicating IDbSet&lt;TEntity&gt; to prevent exposure of DbSet and DbQuery up the stack.
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    /// <remarks>
    /// This tradeoffs breaking when EF changes against having all components taking an EntityFramework package dependency.
    /// </remarks>
    public interface IEntitySet<TEntity> : IOrderedQueryable<TEntity>, IListSource where TEntity : class
    {
        /// <summary>
